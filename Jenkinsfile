        ...
        stage('Running test suites') {
            ...
            steps {
                catchError(buildResult: 'SUCCESS', stageResult: 'FAILURE'){
                   ...
                   sh label: 'build-loadrun', script: 'cd /home/jenkins/go/src/infini.sh/loadgen/cmd/loadrun && make build && cp ./bin/run /home/jenkins/go/src/infini.sh/testing/bin/'
                   ...
                   sh label: 'test', script: 'cd /home/jenkins/go/src/infini.sh/testing && ./bin/loadrun -config ./suites/jenkins.yml'
                }
            }
        }
